...
- Name: admin.spec.js >> ADMIN — Acceso protegido y Dashboard >> [ADM-07] La tabla de órdenes tiene el selector de estado
- Location: tests\admin.spec.js:76:3
...
Call log:
  - waiting for getByRole('button', { name: /Órdenes/ }).first()
