...
- Name: checkout.spec.js >> CHECKOUT — Formulario y selector de envío >> [CHK-07] El formulario requiere campos obligatorios (no envía vacío)
- Location: tests\checkout.spec.js:73:3
...
Call log:
  - waiting for getByRole('button', { name: /[Pp]agar ahora/ })
