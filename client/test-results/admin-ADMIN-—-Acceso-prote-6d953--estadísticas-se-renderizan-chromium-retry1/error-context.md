...
- Name: admin.spec.js >> ADMIN — Acceso protegido y Dashboard >> [ADM-04] Las 4 tarjetas de estadísticas se renderizan
- Location: tests\admin.spec.js:37:3
...
Call log:
  ...
  - waiting for getByText('Ventas hoy')
