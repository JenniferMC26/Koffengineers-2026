...
- Name: checkout.spec.js >> CHECKOUT — Formulario y selector de envío >> [CHK-06] El panel de resumen muestra el producto del carrito
- Location: tests\checkout.spec.js:66:3
...
Locator: getByText('Auriculares Bluetooth Pro').last()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Auriculares Bluetooth Pro').last()
...
- navigation "Navegación principal":
  ...
  - link "Cuenta":
    - /url: /login
  - button "Carrito, 1 artículos": 1 Carrito
- main:
  - img
```
