...
- Name: checkout.spec.js >> CHECKOUT — Formulario y selector de envío >> [CHK-03] Los dos métodos de envío obligatorios se muestran
- Location: tests\checkout.spec.js:35:3
...
Call log:
  ...
  - waiting for getByText('Estándar')
