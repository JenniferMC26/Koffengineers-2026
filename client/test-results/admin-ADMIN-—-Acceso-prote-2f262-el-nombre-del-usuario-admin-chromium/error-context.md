...
- Name: admin.spec.js >> ADMIN — Acceso protegido y Dashboard >> [ADM-10] El sidebar muestra el nombre del usuario admin
- Location: tests\admin.spec.js:115:3
...
Call log:
  ...
  - waiting for getByText('Admin CLYRO')
