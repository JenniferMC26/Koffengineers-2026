...
- Name: checkout.spec.js >> CHECKOUT — Formulario y selector de envío >> [CHK-08] Envío exitoso muestra toast y redirige al home
...
Call log:
  - waiting for getByPlaceholder(/Tu nombre completo/)
