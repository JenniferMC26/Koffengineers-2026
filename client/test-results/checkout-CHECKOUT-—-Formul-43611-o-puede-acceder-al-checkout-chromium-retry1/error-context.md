...
- Name: checkout.spec.js >> CHECKOUT — Formulario y selector de envío >> [CHK-02] Usuario autenticado con carrito puede acceder al checkout
- Location: tests\checkout.spec.js:27:3
...
Locator: getByText(/[Cc]onfirmar pedido/)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/[Cc]onfirmar pedido/)
