...
- Name: admin.spec.js >> ADMIN — Acceso protegido y Dashboard >> [ADM-08] Vista de Productos renderiza la lista de inventario
- Location: tests\admin.spec.js:88:3
...
Call log:
  - waiting for getByRole('button', { name: /Productos/ }).first()
