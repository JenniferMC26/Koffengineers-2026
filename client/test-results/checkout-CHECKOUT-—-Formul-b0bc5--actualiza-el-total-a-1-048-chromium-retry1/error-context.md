...
- Name: checkout.spec.js >> CHECKOUT — Formulario y selector de envío >> [CHK-05] Express ($149) actualiza el total a $1,048
- Location: tests\checkout.spec.js:56:3
...
Call log:
  - waiting for getByRole('button', { name: /Express/ })
